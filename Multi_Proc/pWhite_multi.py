...
#INPUT 
#WHITE_IN.v foldername (DARK_IN.v) (FLAT_IN.v)
...
#Load external data
white = pyvips.Image.new_from_file(foldername+'\\'+sys.argv[1], access='sequential')
...
wdist = 0
wdat, wdist = readheader(raw_path + '\\'+foldername+ '\\' + input_name + '.dat') ## wdat is intergration time again
